                      ...
                      <div class="row">
                       ...
                       <div class="x_panel">
                            ...
                            <div class="x_content ">
                              <div class=" ">
                                ...
                                <div class="form-group">
                                  <label for="ex3">For period from</label>
                                    <input id="datetimepicker4" class="form-control" type="text" placeholder="03/06/2018 8:24 PM" style="width: 83px;">
                                </div>
                                <div class="form-group">
                                  <label for="ex4">To:</label>
                                   <input id="datetimepicker3" class="form-control" type="text" placeholder="03/06/2018 8:24 PM" style="width: 83px;">
                                </div>
                                
                              </form>
                              <div class="col-sm-12 ">
                                <div class="checkbox checkbox-success col-sm-12 col-md-12 col-xs-12">
                                    <input type="checkbox"> <label> Show Inactive Items as well</label>
                                  </div>
                                <div class="checkbox checkbox-success col-sm-12 col-md-12 col-xs-12">
                                    <input type="checkbox"> <label class="checkbox">Show Only Inactive Items</label>
                                  </div>
                                </div>
                              <form class="form-inline">
                              <div class="form-group">
                                <span style="display:inline-block;text-align:left;padding:3px;">
                                          <div class="page_emph"><label>Users:</label></div>
                                          <select name="timekeepers" size="10" multiple="" class="form-control">
                                      <option value="A" selected="">(All listed below)</option>
                                      <option value="48226">Bell, Terry </option>
                                      <option value="50385">Burgraff, Kimberly </option>
                                      <option value="48227">Clarambeau, Adlore </option>
                              ...
                              <div class="form-group">
                                <span style="display:inline-block;text-align:left;padding:3px;">
                                <div class="page_emph"><label>Matters:</label></div>
                                <select name="projects" size="10" multiple="" class="form-control">
                            <option value="A" selected="">(All listed below)</option>
                        ...
                        <div class="settings-text">
                          ...
                          <button class="btn btn-primary">Printable Report</button>
                        </div>
