          ...
          <div class="">
            <!-- <div class="page-title">
              <div class="title_left">
                <br>
                <p>Dashboard / Timesheet Approval Status - View Only</p>
              </div>
                ...
                <div class="table-responsive">
                  <table class="table table-striped jambo_table bulk_action table-bordered">
                    <div >
                     ...
                     <div>
                       <span style="background-color: lightgrey">Total <a href="#">show/hide details</a></span>
                       <span style="background-color: lightgrey">12</span>
