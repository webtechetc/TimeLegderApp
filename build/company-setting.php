    ...
    <div class="container body">
      <div class="main_container">
                    ...
                    <button class="btn btn-primary" type="button">Save Changes</button>
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" >
                              <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Company Info</strong> </h3>
                             </div>
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" >
                              <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Billing Info</strong> </h3>
                             </div>
                              <div class="x_content open-content" >
                                <br>
                                <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left">
                                  ...
                                  <legend class="col-sm-12">Accounts Payable Contact</legend>
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" >
                              <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Currency Setting</strong> </h3>
                             </div>
                              <div class="x_content open-content" >
                                <br>
                                <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" >
                              <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Profit Calculations Settings</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use calculation" >
                                <br>
                                <div class="row">
                                    <div class="col-xs-12">
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" >
                              <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Matter Billing Options</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use matter" >
                                <br>
                                <div class="row">
                                    <div class="col-xs-12">
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel " >
                              <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Expense Markup or Discount</strong> </h3>
                             </div>
                              <div class="x_content open-content">                                
                                <div class="row">
                                  <div class="col-xs-12">
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" >
                              <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Permissions and Assignments</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use permissions">
                                 <br>
                                  <div class="row">
                                    <div class="col-xs-12">
                                      <div class="checkbox checkbox-success">
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                              <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Time Entry Screen Settings</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use entryscreen">
                                 <br>
                                  <div class="row">
                                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Emailing Time Entries Into TimeLedger</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use">
                                  <br>
                                  <div class="row">
                                      <div class="col-xs-12">
                                        <div class="checkbox  checkbox-success">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                               <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Timesheet Approval Settings</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use approvals">
                                  <br>
                                  <div class="row">
                                      <div class="col-xs-12">
                                        <div class="checkbox  checkbox-success">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Maximum Time Entry Limits</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use">
                                <div class="row">
                                    <div class="col-xs-12">
                                       <legend>Block users from entering time beyond these daily and weekly maximum levels:
                                       </legend>
                                       <div class="checkbox checkbox-inline checkbox-success">
                                        ...
                                        <input size="5" maxlength="20" class=""  name="" value="16.0" type="text"> hours
                                        <div class="checkbox checkbox-inline  checkbox-success">
                                        <input name="" checked="" type="checkbox"> 
                                        <label>Maximum allowable time entry for any calendar week (through Saturday):</label>
                                        
                                      </div>
                                        <input size="5" maxlength="20" name="" value="168.0" type="text"> hours
                                      </div>
                                    </div>
                                    <div class="clearfix">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Printable Timesheet Settings</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use printable">
                                  <br>
                                <div class="row">
                                    <div class="col-xs-12">
                                      ...
                                      <div class="outline col-sm-6 ">
                                        ...
                                        <div class="outline col-sm-6 vspace" style="float:left;">
                                          ...
                                          <tr>
                                            ...
                                            <td><div class=" checkbox checkbox-success"><input name="tp_comment" checked="" type="checkbox"><label>&nbsp;Comments</label></div>
                                          </tr>
                                          </tbody></table>
                                          </div>
                                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                              <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Payroll Settings</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use payroll">
                                <br>
                                <div class="row">
                                    <div class="col-xs-12">
                        ...
                        <!-- row Start -->
                          ...
                          <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Printable Expense Settings</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use">
                                  <br>
                                  <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                ...
                                <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>Terms to be Used Throughout TimeLedger</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use termsto ">
                                  <br>
                                  <div class="row">
                                      <div class="col-xs-12">
                                        <div class="table-responsive">
                        ...
                        <!-- row Start -->
                          <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                 <div class="timesheet-view" style="margin-left: 8px;"> <h3><strong>TimeLedger Appearance</strong> </h3>
                             </div>
                              <div class="x_content open-content table-use appearancetime">
                                  <br>
                                  <div class="row">
                                      <div class="col-xs-12">
                                        <div class="table-responsive">
        ...
        <footer style="margin-left: 0">
          <div>
         <P> Copyright © 1997-2018 Equative, Inc.<br/> All Rights Reserved.</P>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
