          ...
          <div class="">
           <!--  <div class="page-title">
              <div class="title_left">
                <br>
                <p>Dashboard / Expense Entry Detail</p>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <form class="form-inline">
                                <div class="form-group">
                                  <label for="ex3">For period from</label>
                                    <input id="datetimepicker4" class="form-control" type="text" placeholder="03/06/2018 8:24 PM">
                                </div>
                                <div class="form-group">
                                  <label for="ex4">To:</label>
                                   <input id="datetimepicker3" class="form-control" type="text" placeholder="03/06/2018 8:24 PM">
                                </div>
                                <div class="checkbox checkbox-success form-group">
                                    <input type="checkbox"> <label class="checkbox"> Show Inactive Items as well</label>
                    ...
                    <div class="text-center ">
                        <div class=" btn-group">
                          <button class="btn btn-default">Display Report</button>
