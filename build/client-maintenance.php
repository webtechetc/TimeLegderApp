            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="col-sm-12 ">
                    <div class="row settings-text form-inline">
                        <button class="btn btn-primary "> Select Another Client</button>
                     <button class="btn btn-primary">Add New Client</button>
                     <button class="btn btn-primary">View Matters for this Client</button>
                      <button class="btn btn-primary">Add a Matter for this Client</button>
                      <button class="btn btn-primary"> Assign Existing Matters for this Client</button>
                    </div>
                  </div>
                  <div class="col-xs-12 settings-text">
                    ...
                    <div class="col-sm-6">
                      <form class="">
                        ...
                        <input type="" class="form-control" value="Invoice Ann Edwards" name="">
