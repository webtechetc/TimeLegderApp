          ...
          <div class="">
            <!-- <div class="page-title">
              <div class="title_left">
                <br>
                <p>Dashboard / Expenses by User</p>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <form class="form-inline text-center">
                          ...
                          <form class="form-group text-center" style="margin-top: 10px;">
                          <label >To see all data on one page -- please select one of these export formats:</label>
                        </form>
                        </div>
